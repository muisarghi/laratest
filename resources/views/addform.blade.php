        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
					...
					<br><br>
					<form method="POST" action="addingform" enctype="multipart/form-data">
                        @csrf
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tgllhr" type="text" class="form-control @error('tgllhr') is-invalid @enderror" name="tgllhr" value="{{ old('tgllhr') }}" required autocomplete="tgllhr" autofocus>
